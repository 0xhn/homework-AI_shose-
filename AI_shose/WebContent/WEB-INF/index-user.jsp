    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          ...
          <li><a href="ExitSevlet"><span class="am-icon-power-off"></span> 退出</a></li>
        </ul>
      </li>
  ...
  <div class="admin-sidebar">
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> 用户信息<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
          <li><a href="SelectUserById?id=${user.id}" class="am-cf"><span class="am-icon-check"></span> 修改用户信息<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
      ...
      <li><a href="ExitSevlet"><span class="am-icon-sign-out"></span> 注销</a></li>
    </ul>
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="UpdateUserServlet" method="post">
        
            <div class="am-form-group">
            <label for="user-phone" class="am-u-sm-3 am-form-label">id</label>
            <div class="am-u-sm-9">        
              <input type="text" id="user-phoe"   value="${user.id }" name="id"/>
            </div>
          </div>
...
<!--          
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" placeholder="输入密码"></textarea>
              <small>输入mima</small>
            </div>
          </div>
 -->
